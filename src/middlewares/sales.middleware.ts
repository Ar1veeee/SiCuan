...
export const validateSalesId = (req: Request, res: Response, next: NextFunction): void => {
    try {
...
export const verifyAndAttachSalesItem = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
