 ...
 */
export const verifyAndAttachMenu = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
        ...
        if (!menu) {
            throw ApiError.forbidden("Menu tidak ditemukan atau Anda tidak memiliki akses.");
        }
