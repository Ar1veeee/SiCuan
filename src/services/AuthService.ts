...
export const userRegister = async (username: string, email: string, password: string, nama_usaha: string): Promise<object> => {
...
export const userLogin = async (email: string, password: string): Promise<object> => {
